...
interface CostCalculationBatchRepository : JpaRepository<CostCalculationBatch, UUID> {
    ...
    @Query("SELECT b FROM CostCalculationBatch b WHERE b.targetMonth = :targetMonth ORDER BY b.createdAt DESC")
    fun findByTargetMonth(targetMonth: YearMonth): List<CostCalculationBatch>
